...
typedef volatile struct ATTR_PACKED_ALIGNED4 _LPC23XX_GPIO {
    uint32_t  PIN;                  /* RW  IOx Base + 0x00 */
    uint32_t  SET;                  /* RW  IOx Base + 0x04 */
    uint32_t  DIR;                  /* RW  IOx Base + 0x08 */
    uint32_t  CLR;                  /* WO  IOx Base + 0x0C */
}  LPC23XX_GPIO_t, *P_LPC23XX_GPIO_t;

#define P_GPIO0_REGS ((LPC23XX_GPIO_t *)GPIO_BASE_ADDR)
#define P_GPIO1_REGS ((LPC23XX_GPIO_t *)GPIO_BASE_ADDR + 0x10)
...
typedef volatile struct ATTR_PACKED_ALIGNED4 _LPC23XX_GPIOINT {
    uint32_t  Status;               /* RO  GPIO_BASE_ADDR + 0x80 */
}  LPC23XX_GPIOINT_t, *P_LPC23XX_GPIOINT_t;

#define P_GPIO_INT_REGS ((LPC23XX_GPIOINT_t *)GPIO_BASE_ADDR + 0x80)


typedef volatile struct ATTR_PACKED_ALIGNED4 _LPC23XX_GPIOXINT {
...
}  LPC23XX_GPIOXINT_t, *P_LPC23XX_GPIOXINT_t;

#define P_GPIO0_INT_REGS ((LPC23XX_GPIOXINT_t *)GPIO_BASE_ADDR + 0x84)
#define P_GPIO2_INT_REGS ((LPC23XX_GPIOXINT_t *)GPIO_BASE_ADDR + 0xA4)
...
typedef volatile struct ATTR_PACKED_ALIGNED4 _LPC23XX_FIO {
    union ATTR_PACKED {
...
}  LPC23XX_FIO_t, *P_LPC23XX_FIO_t;

#define P_FIO0_REGS     ((LPC23XX_FIO_t *)(FIO_BASE_ADDR + 0x00))
#define P_FIO1_REGS     ((LPC23XX_FIO_t *)(FIO_BASE_ADDR + 0x20))
#define P_FIO2_REGS     ((LPC23XX_FIO_t *)(FIO_BASE_ADDR + 0x40))
#define P_FIO3_REGS     ((LPC23XX_FIO_t *)(FIO_BASE_ADDR + 0x60))
#define P_FIO4_REGS     ((LPC23XX_FIO_t *)(FIO_BASE_ADDR + 0x80))
