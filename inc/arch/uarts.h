...
#define LPC2378_UART0_BASE      (0xE000C000)
#define U0RBR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x00)) /* RO */          
#define U0THR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x00)) /* WO */
#define U0DLL   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x00)) /* RW */
#define U0DLM   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x04)) /* RW */
#define U0IER   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x04)) /* RW */
#define U0IIR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x08)) /* RO */
#define U0FCR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x08)) /* WO */
#define U0LCR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x0C)) /* RW */
#define U0LSR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x14)) /* RO */
#define U0SCR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x1C)) /* RW */
#define U0ACR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x20)) /* RW */
#define U0ICR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x24)) /* RW */
#define U0FDR   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x28)) /* RW */
#define U0TER   (*(volatile uint8_t  *)(LPC2378_UART0_BASE + 0x30)) /* RW */

#define LPC2378_UART2_BASE      (0xE0078000)

typedef volatile struct ATTR_PACKED_ALIGNED4 _LPC23XX_UART {
...
#define P_UART0_REGS ((LPC23XX_UART *)LPC2378_UART0_BASE)
#define P_UART2_REGS ((LPC23XX_UART *)LPC2378_UART2_BASE)
...
/* TODO move this to application files */
