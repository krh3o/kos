...
/* TODO fix name space clash, rename struct members */
#if 0
#define MAMCR           (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x000))  /* RW */
#define MAMTIM          (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x004))  /* RW */

#define MEMMAP          (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x040))  /* RW */

#define PLLCON          (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x080))  /* RW */
#define PLLCFG          (*(volatile uint32_t *)(LPC2378_SCB_BASE + 0x084))  /* RW */
#define PLLSTAT         (*(volatile uint32_t *)(LPC2378_SCB_BASE + 0x088))  /* RO */
#define PLLFEED         (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x08C))  /* WO */

#define PCON            (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x0C0))  /* RW */
#define PCONP           (*(volatile uint32_t *)(LPC2378_SCB_BASE + 0x0C4))  /* RW */

#define CCLKCFG         (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x104))  /* RW */
#define USBCLKCFG       (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x108))  /* RW */
#define CLKSRCSEL       (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x10C))  /* RW */

#define EXTINT          (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x140))  /* RW */
#define INTWAKE         (*(volatile uint16_t *)(LPC2378_SCB_BASE + 0x144))  /* RW */
#define EXTMODE         (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x148))  /* RW */
#define EXTPOLAR        (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x14C))  /* RW */

#define RSID            (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x180))  /* RW */
#define CSPR            (*(volatile uint32_t *)(LPC2378_SCB_BASE + 0x184))  /* WO */
#define AHBCFG1         (*(volatile uint32_t *)(LPC2378_SCB_BASE + 0x188))  /* RW */
#define AHBCFG2         (*(volatile uint32_t *)(LPC2378_SCB_BASE + 0x18C))  /* RW */

#define SCS             (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x1A0))  /* RW */
#define IRCTRIM         (*(volatile uint16_t *)(LPC2378_SCB_BASE + 0x1A4))  /* RW */
#define PCLKSEL0        (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x1A8))  /* RW */
#define PCLKSEL1        (*(volatile uint8_t  *)(LPC2378_SCB_BASE + 0x1AC))  /* RW */
#endif


typedef volatile struct ATTR_PACKED_ALIGNED4 _LPC23XX_SCB {
                                /* Access Offset */
...
} LPC23XX_SCB_t, *P_LPC23XX_SCB_t;

#define P_SCB_REGS ((LPC23XX_SCB_t *)LPC2378_SCB_BASE)
